...
public class AppAutoRunAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_app_auto_run, null);
            holder.name = (TextView) convertView.findViewById(R.id.item_app_auto_run_name);
            holder.icon = (ImageView) convertView.findViewById(R.id.item_app_auto_run_iv);
