...
package com.sdt.tv.launcher.features.indicator;
...
public class TabIndicator extends LinearLayout
        implements TabButton.OnTabButtonChangeListener, TabButton.OnTabButtonClickListener {
    ...
    private ArrayList<TabButton> mTabButtonList = new ArrayList<TabButton>();
    ...
    private void initUI() {
        ...
        int[] ids = { R.id.indicator_tab1, R.id.indicator_tab2, R.id.indicator_tab3, };
    ...
    public void requestTabFocus(int index) {
        Log.i("ZYTFOC", " tab layout is getting focus ");
        Log.i("ZYTFOC", " focus index is " + index);
