...
package com.sdt.tv.launcher.widget;

import com.sdt.tv.launcher.R;
import com.sdt.tv.launcher.util.TimeUtil;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (wifiInfo.getBSSID() != null) {
                ...
                if (signalLevel == 0) {
                    ...
                    imgNetWorkState.setImageDrawable(context.getResources().getDrawable(R.drawable.network_state_on));
                }
            }
        }
    };
